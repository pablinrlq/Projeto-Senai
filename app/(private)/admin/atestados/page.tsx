...
import { ArrowLeft, CheckCircle, XCircle, Clock, Eye, User, FileText } from 'lucide-react';
    ...
    return (
      <div className="flex min-h-screen items-center justify-center">
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <Button onClick={() => router.push("/atestados")}>
              Voltar
            </Button>
          </CardContent>
        </Card>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto p-4 md:p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-primary mb-2">Revisar Atestados</h1>
          <p className="text-muted-foreground">Analise e aprove ou rejeite atestados enviados pelos alunos</p>
        </div>
